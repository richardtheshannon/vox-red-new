...
interface GoalSlideModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
}

export default function GoalSlideModal({ isOpen, onClose, onSuccess }: GoalSlideModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/slides/goal-slide', {
        method: 'POST',
        headers: {
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                disabled={isSubmitting}
                placeholder="Enter your goal content..."
                rows={10}
            ...
            {showSuccess && (
              ...
              >
                Goal created successfully! Refreshing...
              </div>
            )}
